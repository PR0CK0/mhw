 ...
 * 
 * Weapon_Gunlance object class. Stores all data for an instance of the class.
 * 
 * Extends: Weapon
 *
 */

public class Weapon_Gunlance extends Weapon
{
	private int attack;
	 ...
	 * @param shellingLevel
	 */
	public Weapon_Gunlance(String name, int rarity, int attack, String sharpness, int affinity,
			String elementType, int elementDamage, int hiddenElement, int level1Gem, int level2Gem,
			int level3Gem, int defenseBonus, String elderseal, String shellingType, int shellingLevel)
	{
		type = "gunlance";
		this.name = name;
		this.rarity = rarity;
		...
		this.shellingLevel = shellingLevel;
	}
	...
	public String getAllInfo() {
		allInfo = 
				...
				+ "Shelling type: "  + shellingType + ", at level " + shellingLevel + "\n\n"
