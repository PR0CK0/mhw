 ...
 * 
 * Weapon_LightBowgun object class. Stores all data for an instance of the class.
 * 
 * Extends: Weapon
 *
 */

public class Weapon_LightBowgun extends Weapon
{
	private int attack;
	 ...
	 * @param tranq
	 */
	public Weapon_LightBowgun(String name, int rarity, int attack, int affinity, int level1Gem,
			int level2Gem, int level3Gem, int defenseBonus, String deviation, int modSlots,
			int normal1, int normal2, int normal3, int piercing1,
