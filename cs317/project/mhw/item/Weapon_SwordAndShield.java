 ...
 * 
 * Weapon_SwordAndShield object class. Stores all data for an instance of the class.
 * 
 * Extends: Weapon
 *
 */

public class Weapon_SwordAndShield extends Weapon
{
	private int attack;
	 ...
	 * @param elderseal
	 */
	public Weapon_SwordAndShield(String name, int rarity, int attack, String sharpness, int affinity,
			String elementType, int elementDamage, int hiddenElement, int level1Gem, int level2Gem,
			int level3Gem, int defenseBonus, String elderseal)
	{
		type = "swordandshield";
		this.name = name;
		this.rarity = rarity;
