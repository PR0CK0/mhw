 ...
 * 
 * Weapon_SwitchAxe object class. Stores all data for an instance of the class.
 * 
 * Extends: Weapon
 *
 */

public class Weapon_SwitchAxe extends Weapon
{
	private int attack;
	 ...
	 * @param phialDamage
	 */
	public Weapon_SwitchAxe(String name, int rarity, int attack, String sharpness, int affinity,
			String elementType, int elementDamage, int hiddenElement, int level1Gem, int level2Gem,
			int level3Gem, int defenseBonus, String elderseal, String phialType, int phialDamage)
	{
		type = "switchaxe";
		this.name = name;
		this.rarity = rarity;
	...
	public String getAllInfo()
	{
		allInfo = 
				...
				+ "Phial type: "  + phialType + ", with a damage of " + phialDamage + "\n\n"
