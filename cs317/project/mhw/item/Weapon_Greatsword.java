 ...
 * 
 * Weapon_Greatsword object class. Stores all data for an instance of the class.
 * 
 * Extends: Weapon
 *
 */
...
public class Weapon_Greatsword extends Weapon
{
	 ...
	 * @param elderseal
	 */
	public Weapon_Greatsword(String name, int rarity, int attack, String sharpness, int affinity,
