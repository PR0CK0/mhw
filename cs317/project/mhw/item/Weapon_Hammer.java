 ...
 * 
 * Weapon_Hammer object class. Stores all data for an instance of the class.
 * 
 * Extends: Weapon
 *
 */

public class Weapon_Hammer extends Weapon
{
	private int attack;
	 ...
	 * @param elderseal
	 */
	public Weapon_Hammer(String name, int rarity, int attack, String sharpness, int affinity,
