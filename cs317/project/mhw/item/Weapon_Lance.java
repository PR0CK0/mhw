 ...
 * 
 * Weapon_Lance object class. Stores all data for an instance of the class.
 * 
 * Extends: Weapon
 *
 */

public class Weapon_Lance extends Weapon
{
	private int attack;
	 ...
	 * @param elderseal
	 */
	public Weapon_Lance(String name, int rarity, int attack, String sharpness, int affinity,
