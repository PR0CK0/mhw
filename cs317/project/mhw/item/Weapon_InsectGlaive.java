 ...
 * 
 * Weapon_InsectGlaive object class. Stores all data for an instance of the class.
 * 
 * Extends: Weapon
 *
 */

public class Weapon_InsectGlaive extends Weapon
{
	private int attack;
	 ...
	 * @param kinsectBonus
	 */
	public Weapon_InsectGlaive(String name, int rarity, int attack, String sharpness, int affinity,
			String elementType, int elementDamage, int hiddenElement, int level1Gem, int level2Gem,
			int level3Gem, int defenseBonus, String elderseal, String kinsectBonus)
	{
		type = "insectglaive";
		this.name = name;
		this.rarity = rarity;
		...
		this.kinsectBonus = kinsectBonus;
	}
