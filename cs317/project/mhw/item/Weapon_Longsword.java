 ...
 * 
 * Weapon_Longsword object class. Stores all data for an instance of the class.
 * 
 * Extends: Weapon
 *
 */

public class Weapon_Longsword extends Weapon
{
	private int attack;
	 ...
	 * @param elderseal
	 */
	public Weapon_Longsword(String name, int rarity, int attack, String sharpness, int affinity,
